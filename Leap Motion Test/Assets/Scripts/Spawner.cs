...
public class Spawner : MonoBehaviour {
	...
	void FixedUpdate () {
        ...
        {
            nextWaveText.transform.position = new Vector2(0f, 3.1f);
            wave++;
            isWaving = false;
    ...
    public void nextWave(){
		if(!isWaving){
            ...
            case 3:
                ...
                case 5:
                    waveContent.Clear();
                    waveSpawnCooldown = 40;
                    waveContent.AddRange(new GameObject[] { lumberJack, lumberJack, lumberJack, lumberJack,lumberJack,lumberJack, lumberJack});
                    break;
                case 6:
                    waveContent.Clear();
                    waveSpawnCooldown = 33;
                    waveContent.AddRange(new GameObject[] { lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack,lumberJack,lumberJack});
                    break;
                case 7:
                    waveContent.Clear();
                    waveSpawnCooldown = 25;
                    waveContent.AddRange(new GameObject[] { lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack,lumberJack,lumberJack});
                    break;
                case 8:
                    waveContent.Clear();
                    waveSpawnCooldown = 20;
                    waveContent.AddRange(new GameObject[] { lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack, lumberJack,lumberJack,lumberJack,lumberJack});
                    break;
